...
public static class EntityComponentExtensions
{
	...
	{
		Vector3 translationVector = entity.Transform.WorldMatrix.TranslationVector;
		double num = Math.Atan2(targetPosition.Z - translationVector.Z, targetPosition.X - translationVector.X);
		return (float)num;
	}
}